...
// It takes the deque and last user input as inputs and has no return value as it updates the deque directly
...
// It takes the average of the values in the deque and returns either the average or a random int from 1 - 6
...
// It takes in the average of the values in the deque and returns either the average or a random int from 1 - 6
